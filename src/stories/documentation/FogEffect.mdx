...
<Plot className='w-full' xAspectRatio={[-1.5, 3.5]} options={{
  width: 800,
  height: 500,
  ...
  data: [
    {
      fn: "(2 * 0.1 * 100) / (100 + 0.1 - (2 * x - 1) * (100 - 0.1))",
      nSamples: 80,
      closed: true
    }
  ],
...
<Plot className='w-full' xAspectRatio={[-1, 180]} options={{
  width: 800,
  height: 500,
  ...
  data: [
    {
      fn: "1. - min(abs((2 * 0.1 * 100) / (100 + 0.1 - (2 * x - 1) * (100 - 0.1)) - 1.0) / sin(x / 3) * 10 + 25, 1.)",
      range: [0, Infinity],
      closed: true
    },
    {
