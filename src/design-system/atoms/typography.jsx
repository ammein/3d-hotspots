...
/**
 * @type {import('tailwind-styled-components/dist/tailwind').TailwindComponent<'web' , HeadingParams & React.HTMLAttributes<HTMLHeadingElement>>}
 */
export const Heading = tw(headingStyle)`${(props) =>
  props.weight === 'semibold' ? 'font-semibold' : 'font-bold'} ${(props) =>
  props.color}`;
