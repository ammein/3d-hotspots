...
const Model = ({ url, useDraco, useMeshOptimize = true, animationNames = [], hideItems = [], ...rest }) => {
  ...
  /** @type {[boolean, Function]} */
  const [isAnimate, _setAnimate] = useState(false);
  ...
  const gltf = useMemo(() => {
    ...
    try {
      ...
      gltf = useGLTF(urlDebounced, useDraco, useMeshOptimize, (loader) => {
    ...
    */
    ...
    return gltf;
  }, [gl, urlDebounced, useDraco, useMeshOptimize]);
  ...
  }, [gltf, animationNames, hideItems, CanvasTheatreJS, actions, gl.domElement.style]);
  ...
  }, [rest.start, rest.theatreObjects, sheet.sequence]);
  ...
  }, [urlDebounced, gltf, metadata, hideItems.length]); // Run Once
  ...
  }, [HotspotLinesTheatreJS, gltf, metadata.screens]);
